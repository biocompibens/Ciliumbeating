...
% 
% figure
% [H,P,KSSTAT]=kstest2(ND(:,1),TD(:,1));
% h=scatter(ones(size(ND(:,1))),ND(:,1),50*ND(:,1),[ND(:,1) ND(:,1) 0.9*ones(size(ND(:,1)))],'filled');
% child=get(h,'Children');
% set(child,'FaceAlpha',0.75);
% hold on
% h=scatter(2*ones(size(TD(:,1))),TD(:,1),50*TD(:,1),[0.9*ones(size(TD(:,1))) TD(:,1) TD(:,1)],'filled');
% child=get(h,'Children');
% set(child,'FaceAlpha',0.75);
% xlim([0.5 2.5])
% ylim([0.3 0.8])
...
% text(2,0.76,'shCobl','FontName','Times','fontsize',15,'Color',[0.8 0.1 0.1]);
% text(2,0.79,'shCtrl','FontName','Times','fontsize',15,'Color',[0.1 0.1 0.8]);
% % text(-35,21,'Others','FontName','Times','fontsize',15,'Color',[0.5 0.5 0.5]);
% title(['Dispersion distribution Mean, P = ' num2str(P)],'FontName','Times','fontsize',22);
% xlabel('Experiment type','FontSize',16,'FontName','Times');
% ylabel('Normalized std of distance from center', 'FontSize', 16,'FontName','Times') % y-axis label
% ax = gca;
% grid off
...
% print([FR filesep 'DispersionM'], '-dpng', '-r600');
% 
% 
% figure
% [H,P,KSSTAT]=kstest2(ND(:,2),TD(:,2));
% h=scatter(ones(size(ND(:,2))),ND(:,2),50*ND(:,2),[ND(:,2) ND(:,2) 0.9*ones(size(ND(:,2)))],'filled');
% child=get(h,'Children');
% set(child,'FaceAlpha',0.75);
% hold on
% h=scatter(2*ones(size(TD(:,2))),TD(:,2),50*TD(:,2),[0.9*ones(size(TD(:,2))) TD(:,2) TD(:,2)],'filled');
% child=get(h,'Children');
% set(child,'FaceAlpha',0.75);
% xlim([0.5 2.5])
% ylim([0.3 0.8])
...
% text(2,0.79,'shCtrl','FontName','Times','fontsize',15,'Color',[0.1 0.1 0.8]);
% % text(-35,21,'Others','FontName','Times','fontsize',15,'Color',[0.5 0.5 0.5]);
% title(['Dispersion distribution Area, P = ' num2str(P)],'FontName','Times','fontsize',22);
% xlabel('Experiment type','FontSize',16,'FontName','Times');
% ylabel('Normalized std of distance from center', 'FontSize', 16,'FontName','Times') % y-axis label
% ax = gca;
% grid off
...
% set(gcf,'PaperPositionMode','auto')
% %  export_fig([FR filesep 'Vector_angle9'],'-native', '-a2', '-m4','-q101','-png', '-r600');
% print([FR filesep 'DispersionA'], '-dpng', '-r600');
% 
% 
% 
% figure
...
hh1 = hatchfill(h, 'single',Center(kin)+90, 3);
...
h = patch(Xin2(:,kin), Yin2(:,kin), 'w');
alpha(h, 0.5)        %# note: this switches to OpenGL renderer
set(h,'EdgeColor',[0.8 0.1 0.1],'LineStyle','-','Linewidth',.5);

hh1 = hatchfill(h, 'single',Center(kin)+45, 3);
set(hh1, 'Color',[0.8 0.1 0.1])
