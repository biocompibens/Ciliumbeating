...
function [arrowx,arrowy]=vekplot3(x,y,u,v,scale)
...
rel_head=0.3125; % length of arrow head relative to total length
% *****
min_head=0.0; % minimum length of arrow head

alfa=pi/7.5; % half opening angle of arrow head
